    ...
    >
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        ...
        <Modal.Body className="text-center px-4 pb-5 pt-3">
          <p style={{ color: "#4a5568", fontSize: "1rem", marginBottom: "2rem", lineHeight: "1.5" }}>
            Al continuar con Google aceptás nuestros
            <br />
            <a href="/terminos" style={{ color: "#2F416A", textDecoration: "underline", fontWeight: "600" }}>Términos</a>
            {" y "}
            <a href="/privacidad" style={{ color: "#2F416A", textDecoration: "underline", fontWeight: "600" }}>Política de Privacidad</a>
          </p>
          ...
          <button
            ...
            disabled={signingIn}
            style={{ opacity: signingIn ? 0.7 : 1, width: "100%", maxWidth: "300px", margin: "0 auto" }}
          >
            <div className="gsi-material-button-state"></div>
            <div className="gsi-material-button-content-wrapper">
              <div className="gsi-material-button-icon">
                {signingIn ? (
                  <div style={{ width: "18px", height: "18px", border: "2px solid #e0e0e0", borderTopColor: "#016390", borderRadius: "50%", animation: "navSpinner 0.6s linear infinite", margin: "auto" }} />
                ) : (
              ...
              <span className="gsi-material-button-contents">{signingIn ? "Cargando..." : "Continuar con Google"}</span>
            </div>
          </button>
        </Modal.Body>
      </Modal>
