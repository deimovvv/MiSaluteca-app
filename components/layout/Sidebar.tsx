    ...
    <>
      ...
      <div className="p-4 border-bottom d-flex align-items-center justify-content-between">
        <Link href="/app" className="text-decoration-none d-flex align-items-center gap-2 gap-md-3">
          <img
            src="https://res.cloudinary.com/dfoh7ntxq/image/upload/v1766024851/saludchiquito_ojbsip.png"
            alt="Mi Saluteca"
            className="d-block"
            style={{
              width: "32px",
          ...
          />
          <img
            src="https://res.cloudinary.com/ddtijknfn/image/upload/v1768189585/Mi_Saluteca_Azul_rbupo7.png"
            alt="Mi Saluteca"
            className="d-block"
            style={{
              height: "22px",
