...
export default function StudyDetailPage() {
    ...
    return (
      <AppShell title="Estudio no encontrado">
        <div className="empty-state">
          ...
          <Button className="btn-primary-saluteca" onClick={() => router.push("/app/studies")}>
  ...
  return (
    <AppShell
      title={study.title || categoryInfo.label}
      action={
        <div className="d-flex gap-2">
          ...
          <Button
            ...
            onClick={() => {
              ...
              console.log("Download/view file:", study.fileKey);
            }}
          >
            <svg
              width="16"
    ...
    >
      ...
      <div className="mb-4">
        <Button
          variant="link"
          className="text-decoration-none text-primary-saluteca p-0"
          onClick={() => router.back()}
        >
          <svg
            width="16"
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-8">
          ...
          <div className="card card-saluteca">
            <div className="card-body">
              <h2 className="h6 fw-semibold mb-3">Vista previa del archivo</h2>
              <div
                className="bg-light rounded d-flex align-items-center justify-content-center"
                style={{ minHeight: "400px" }}
              >
                {study.fileName.endsWith(".pdf") ? (
                  <div className="text-center">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        // TODO: Implement file download/view from backend
                        console.log("Open PDF:", study.fileKey);
                      }}
                    >
                      Abrir PDF
                    </Button>
              ...
              <div className="d-grid gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    console.log("Download file:", study.fileKey);
                  }}
                >
                  <svg
                    width="16"
          ...
          <div className="card card-saluteca">
            <div className="card-body">
              ...
              <div className="d-flex flex-column gap-3" style={{ fontSize: "0.875rem" }}>
                <div>
                  <div className="text-muted-saluteca mb-1">Tipo de estudio</div>
                  <div className="fw-medium">{categoryInfo.label}</div>
                </div>
                <div>
                ...
                <div>
                  <div className="text-muted-saluteca mb-1">Formato</div>
                  <div className="fw-medium">
                    {study.fileName.endsWith(".pdf") ? "PDF" : "Imagen"}
                  </div>
                </div>
              </div>
            </div>
